...
public class ProductController {
    ...
    public ResponseEntity<Product> saveProduct(
        ...
        productPublisher.publishProductEvent(productCreated, EventType.PRODUCT_CREATED, "ednaldo");
    ...
    public ResponseEntity<Product> updateProduct(
        ...
        if (productRepository.existsById(id)) {
            ...
            productPublisher.publishProductEvent(productUpdated, EventType.PRODUCT_UPDATED, "ednaldo");
    ...
    public ResponseEntity<Product> deleteProduct(@PathVariable("id") long id) {
        ...
        if (optProduct.isPresent()) {
            ...
            productPublisher.publishProductEvent(product, EventType.PRODUCT_DELETED, "ednaldo");
